...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.humanbooster.ar.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.humanbooster.ar.repository.UserRepository.USERS_BY_EMAIL_CACHE);
